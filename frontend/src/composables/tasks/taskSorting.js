import { createDefaultTaskSorts } from "./taskConstants";
import { normalizeComparable } from "./taskFormatters";
...
export function sortTaskRows(rows, sorts) {
  const activeSorts = sorts.length ? sorts : createDefaultTaskSorts();
...
export function getNextTaskSorts(currentSorts, key, event) {
